...
def summarize_run(rows: list[dict[str, Any]], targets: list[float], wall_times: list[float]) -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {
        ...
        "optimizer_step_time_total_sec": _float(last, "optimizer_step_time_total_sec"),
        "train_compute_time_total_sec": _float(last, "train_compute_time_total_sec"),
        "eval_time_total_sec": _float(last, "eval_time_total_sec"),
...
def aggregate_summaries(summaries: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    numeric_keys = [
        ...
        "best_val_loss",
        "wall_time_sec",
        "optimizer_step_time_total_sec",
        "train_compute_time_total_sec",
        "eval_time_total_sec",
        "tokens_per_sec",
        "peak_memory_mb",
        "last_grad_norm",
